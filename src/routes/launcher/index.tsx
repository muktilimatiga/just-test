...
export function Launcher() {
    ...
    return (
        <div className="p-8 md:p-12 max-w-[1600px] mx-auto animate-in fade-in duration-500 py-8">
            {/* MANUAL CONFIG (Was 'basic') */}
            <ConfigModalTest
                isOpen={modalType === 'config'}
                onClose={() => setModalType('none')}
                type="manual" // Changed from "basic" to "manual"
            />
            ...
            <TicketModal
                ...
                mode="create"
            />
            <TicketModal isOpen={isCreateTicketModalOpen} onClose={() => setCreateTicketModalOpen(false)} mode="create" />
